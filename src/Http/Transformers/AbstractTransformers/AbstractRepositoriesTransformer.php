...
class AbstractRepositoriesTransformer extends AbstractTransformer
{
    ...
    public function transform(Repositories $model)
    {
        ...
        return $this->buildPayload(
            ...
            'registry_username'  =>  $model->registry_username,
            'registry_password'  =>  $model->registry_password,
            ]
        );
    }

    public function includeStates(Repositories $model)
    {
    ...
    public function includeActions(Repositories $model)
    {
    ...
    public function includeMedia(Repositories $model)
    {
    ...
    public function includeSocialMedia(Repositories $model)
    {
    ...
    public function includeComments(Repositories $model)
    {
    ...
    public function includeVotes(Repositories $model)
    {
    ...
    public function includeMeta(Repositories $model)
    {
    ...
    public function includePhoneNumbers(Repositories $model)
    {
    ...
    public function includeAddresses(Repositories $model)
    {
