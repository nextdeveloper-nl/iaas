...
class AbstractNetworkMemberDevicesTransformer extends AbstractTransformer
{
    ...
    public function includeStates(NetworkMemberDevices $model)
    {
    ...
    public function includeActions(NetworkMemberDevices $model)
    {
    ...
    public function includeMedia(NetworkMemberDevices $model)
    {
    ...
    public function includeSocialMedia(NetworkMemberDevices $model)
    {
    ...
    public function includeComments(NetworkMemberDevices $model)
    {
    ...
    public function includeVotes(NetworkMemberDevices $model)
    {
    ...
    public function includeMeta(NetworkMemberDevices $model)
    {
    ...
    public function includePhoneNumbers(NetworkMemberDevices $model)
    {
    ...
    public function includeAddresses(NetworkMemberDevices $model)
    {
