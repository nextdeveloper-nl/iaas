...
class AbstractComputeMemberEventsTransformer extends AbstractTransformer
{
    ...
    public function includeMedia(ComputeMemberEvents $model)
    {
    ...
    public function includeSocialMedia(ComputeMemberEvents $model)
    {
    ...
    public function includeComments(ComputeMemberEvents $model)
    {
    ...
    public function includeVotes(ComputeMemberEvents $model)
    {
    ...
    public function includeMeta(ComputeMemberEvents $model)
    {
    ...
    public function includePhoneNumbers(ComputeMemberEvents $model)
    {
    ...
    public function includeAddresses(ComputeMemberEvents $model)
    {
