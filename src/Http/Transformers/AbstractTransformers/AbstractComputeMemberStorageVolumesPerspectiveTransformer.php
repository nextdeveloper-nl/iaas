 ...
 */
class AbstractComputeMemberStorageVolumesPerspectiveTransformer extends AbstractTransformer
{
    ...
    public function includeStates(ComputeMemberStorageVolumesPerspective $model)
    {
    ...
    public function includeActions(ComputeMemberStorageVolumesPerspective $model)
    {
    ...
    public function includeMedia(ComputeMemberStorageVolumesPerspective $model)
    {
    ...
    public function includeSocialMedia(ComputeMemberStorageVolumesPerspective $model)
    {
    ...
    public function includeComments(ComputeMemberStorageVolumesPerspective $model)
    {
    ...
    public function includeVotes(ComputeMemberStorageVolumesPerspective $model)
    {
    ...
    public function includeMeta(ComputeMemberStorageVolumesPerspective $model)
    {
    ...
    public function includePhoneNumbers(ComputeMemberStorageVolumesPerspective $model)
    {
    ...
    public function includeAddresses(ComputeMemberStorageVolumesPerspective $model)
    {
