 ...
 */
class AbstractVirtualNetworkCardsPerspectiveTransformer extends AbstractTransformer
{
    ...
    public function transform(VirtualNetworkCardsPerspective $model)
    {
        ...
        return $this->buildPayload(
            ...
            'virtual_machine'  =>  $model->virtual_machine,
    ...
    public function includeStates(VirtualNetworkCardsPerspective $model)
    {
    ...
    public function includeActions(VirtualNetworkCardsPerspective $model)
    {
    ...
    public function includeMedia(VirtualNetworkCardsPerspective $model)
    {
    ...
    public function includeSocialMedia(VirtualNetworkCardsPerspective $model)
    {
    ...
    public function includeComments(VirtualNetworkCardsPerspective $model)
    {
    ...
    public function includeVotes(VirtualNetworkCardsPerspective $model)
    {
    ...
    public function includeMeta(VirtualNetworkCardsPerspective $model)
    {
    ...
    public function includePhoneNumbers(VirtualNetworkCardsPerspective $model)
    {
    ...
    public function includeAddresses(VirtualNetworkCardsPerspective $model)
    {
