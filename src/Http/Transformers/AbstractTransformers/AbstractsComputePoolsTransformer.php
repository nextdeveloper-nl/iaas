 ...
 */
class AbstractsComputePoolsTransformer extends AbstractTransformer {
    ...
    public function transform(sComputePools $model) {
                    ...
                    $iaasCloudNodeId = \NextDeveloper\IAAS\Database\Models\sCloudNodes::where('id', $model->iaas_cloud_node_id)->first();
