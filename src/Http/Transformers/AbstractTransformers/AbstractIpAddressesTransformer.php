...
class AbstractIpAddressesTransformer extends AbstractTransformer
{
    ...
    public function transform(IpAddresses $model)
    {
        ...
        return $this->buildPayload(
            ...
            'custom_mac_addr'  =>  $model->custom_mac_addr,
            ]
        );
    }

    public function includeStates(IpAddresses $model)
    {
    ...
    public function includeActions(IpAddresses $model)
    {
    ...
    public function includeMedia(IpAddresses $model)
    {
    ...
    public function includeSocialMedia(IpAddresses $model)
    {
    ...
    public function includeComments(IpAddresses $model)
    {
    ...
    public function includeVotes(IpAddresses $model)
    {
    ...
    public function includeMeta(IpAddresses $model)
    {
    ...
    public function includePhoneNumbers(IpAddresses $model)
    {
    ...
    public function includeAddresses(IpAddresses $model)
    {
