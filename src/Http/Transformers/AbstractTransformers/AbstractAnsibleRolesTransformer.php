...
class AbstractAnsibleRolesTransformer extends AbstractTransformer
{
    ...
    public function includeMedia(AnsibleRoles $model)
    {
    ...
    public function includeSocialMedia(AnsibleRoles $model)
    {
    ...
    public function includeComments(AnsibleRoles $model)
    {
    ...
    public function includeVotes(AnsibleRoles $model)
    {
    ...
    public function includeMeta(AnsibleRoles $model)
    {
    ...
    public function includePhoneNumbers(AnsibleRoles $model)
    {
    ...
    public function includeAddresses(AnsibleRoles $model)
    {
