 ...
 */
class AbstractStorageVolumesPerspectiveTransformer extends AbstractTransformer
{
    ...
    public function transform(StorageVolumesPerspective $model)
    {
        ...
        return $this->buildPayload(
            ...
            'storage_pool'  =>  $model->storage_pool,
            'iaas_storage_pool_id'  =>  $iaasStoragePoolId ? $iaasStoragePoolId->uuid : null,
            'storage_member'  =>  $model->storage_member,
    ...
    public function includeStates(StorageVolumesPerspective $model)
    {
    ...
    public function includeActions(StorageVolumesPerspective $model)
    {
    ...
    public function includeMedia(StorageVolumesPerspective $model)
    {
    ...
    public function includeSocialMedia(StorageVolumesPerspective $model)
    {
    ...
    public function includeComments(StorageVolumesPerspective $model)
    {
    ...
    public function includeVotes(StorageVolumesPerspective $model)
    {
    ...
    public function includeMeta(StorageVolumesPerspective $model)
    {
    ...
    public function includePhoneNumbers(StorageVolumesPerspective $model)
    {
    ...
    public function includeAddresses(StorageVolumesPerspective $model)
    {
