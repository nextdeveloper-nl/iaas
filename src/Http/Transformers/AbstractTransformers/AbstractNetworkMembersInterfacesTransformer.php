...
class AbstractNetworkMembersInterfacesTransformer extends AbstractTransformer
{
    ...
    public function includeStates(NetworkMembersInterfaces $model)
    {
    ...
    public function includeActions(NetworkMembersInterfaces $model)
    {
    ...
    public function includeMedia(NetworkMembersInterfaces $model)
    {
    ...
    public function includeSocialMedia(NetworkMembersInterfaces $model)
    {
    ...
    public function includeComments(NetworkMembersInterfaces $model)
    {
    ...
    public function includeVotes(NetworkMembersInterfaces $model)
    {
    ...
    public function includeMeta(NetworkMembersInterfaces $model)
    {
    ...
    public function includePhoneNumbers(NetworkMembersInterfaces $model)
    {
    ...
    public function includeAddresses(NetworkMembersInterfaces $model)
    {
