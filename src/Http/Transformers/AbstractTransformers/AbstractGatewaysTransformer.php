...
class AbstractGatewaysTransformer extends AbstractTransformer
{
    ...
    public function includeMedia(Gateways $model)
    {
    ...
    public function includeSocialMedia(Gateways $model)
    {
    ...
    public function includeComments(Gateways $model)
    {
    ...
    public function includeVotes(Gateways $model)
    {
    ...
    public function includeMeta(Gateways $model)
    {
    ...
    public function includePhoneNumbers(Gateways $model)
    {
    ...
    public function includeAddresses(Gateways $model)
    {
