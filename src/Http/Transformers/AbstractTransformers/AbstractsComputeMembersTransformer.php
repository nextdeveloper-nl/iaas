 ...
 */
class AbstractsComputeMembersTransformer extends AbstractTransformer {
    ...
    public function transform(sComputeMembers $model) {
                        $iaasComputePoolId = \NextDeveloper\IAAS\Database\Models\sComputePools::where('id', $model->iaas_compute_pool_id)->first();
