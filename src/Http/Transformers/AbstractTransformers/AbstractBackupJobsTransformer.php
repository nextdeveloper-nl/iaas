 ...
 */
class AbstractBackupJobsTransformer extends AbstractTransformer
{
    ...
    public function includeStates(BackupJobs $model)
    {
    ...
    public function includeActions(BackupJobs $model)
    {
    ...
    public function includeMedia(BackupJobs $model)
    {
    ...
    public function includeSocialMedia(BackupJobs $model)
    {
    ...
    public function includeComments(BackupJobs $model)
    {
    ...
    public function includeVotes(BackupJobs $model)
    {
    ...
    public function includeMeta(BackupJobs $model)
    {
    ...
    public function includePhoneNumbers(BackupJobs $model)
    {
    ...
    public function includeAddresses(BackupJobs $model)
    {
