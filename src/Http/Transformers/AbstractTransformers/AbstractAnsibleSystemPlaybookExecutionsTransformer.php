...
class AbstractAnsibleSystemPlaybookExecutionsTransformer extends AbstractTransformer
{
    ...
    public function includeMedia(AnsibleSystemPlaybookExecutions $model)
    {
    ...
    public function includeSocialMedia(AnsibleSystemPlaybookExecutions $model)
    {
    ...
    public function includeComments(AnsibleSystemPlaybookExecutions $model)
    {
    ...
    public function includeVotes(AnsibleSystemPlaybookExecutions $model)
    {
    ...
    public function includeMeta(AnsibleSystemPlaybookExecutions $model)
    {
    ...
    public function includePhoneNumbers(AnsibleSystemPlaybookExecutions $model)
    {
    ...
    public function includeAddresses(AnsibleSystemPlaybookExecutions $model)
    {
