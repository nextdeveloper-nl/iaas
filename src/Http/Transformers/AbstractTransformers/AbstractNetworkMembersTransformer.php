...
class AbstractNetworkMembersTransformer extends AbstractTransformer
{
    ...
    public function includeStates(NetworkMembers $model)
    {
    ...
    public function includeActions(NetworkMembers $model)
    {
    ...
    public function includeMedia(NetworkMembers $model)
    {
    ...
    public function includeSocialMedia(NetworkMembers $model)
    {
    ...
    public function includeComments(NetworkMembers $model)
    {
    ...
    public function includeVotes(NetworkMembers $model)
    {
    ...
    public function includeMeta(NetworkMembers $model)
    {
    ...
    public function includePhoneNumbers(NetworkMembers $model)
    {
    ...
    public function includeAddresses(NetworkMembers $model)
    {
