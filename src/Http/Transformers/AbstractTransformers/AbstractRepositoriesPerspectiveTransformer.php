 ...
 */
class AbstractRepositoriesPerspectiveTransformer extends AbstractTransformer
{
    ...
    public function includeStates(RepositoriesPerspective $model)
    {
    ...
    public function includeActions(RepositoriesPerspective $model)
    {
    ...
    public function includeMedia(RepositoriesPerspective $model)
    {
    ...
    public function includeSocialMedia(RepositoriesPerspective $model)
    {
    ...
    public function includeComments(RepositoriesPerspective $model)
    {
    ...
    public function includeVotes(RepositoriesPerspective $model)
    {
    ...
    public function includeMeta(RepositoriesPerspective $model)
    {
    ...
    public function includePhoneNumbers(RepositoriesPerspective $model)
    {
    ...
    public function includeAddresses(RepositoriesPerspective $model)
    {
