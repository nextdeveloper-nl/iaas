...
class AbstractAnsiblePlaybookAnsibleRolesTransformer extends AbstractTransformer
{
    ...
    public function includeStates(AnsiblePlaybookAnsibleRoles $model)
    {
    ...
    public function includeActions(AnsiblePlaybookAnsibleRoles $model)
    {
    ...
    public function includeMedia(AnsiblePlaybookAnsibleRoles $model)
    {
    ...
    public function includeSocialMedia(AnsiblePlaybookAnsibleRoles $model)
    {
    ...
    public function includeComments(AnsiblePlaybookAnsibleRoles $model)
    {
    ...
    public function includeVotes(AnsiblePlaybookAnsibleRoles $model)
    {
    ...
    public function includeMeta(AnsiblePlaybookAnsibleRoles $model)
    {
    ...
    public function includePhoneNumbers(AnsiblePlaybookAnsibleRoles $model)
    {
    ...
    public function includeAddresses(AnsiblePlaybookAnsibleRoles $model)
    {
