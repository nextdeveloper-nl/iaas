...
class AbstractStoragePoolsTransformer extends AbstractTransformer
{
    ...
    public function includeMedia(StoragePools $model)
    {
    ...
    public function includeSocialMedia(StoragePools $model)
    {
    ...
    public function includeComments(StoragePools $model)
    {
    ...
    public function includeVotes(StoragePools $model)
    {
    ...
    public function includeMeta(StoragePools $model)
    {
    ...
    public function includePhoneNumbers(StoragePools $model)
    {
    ...
    public function includeAddresses(StoragePools $model)
    {
