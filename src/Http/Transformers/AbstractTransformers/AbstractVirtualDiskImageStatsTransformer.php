...
class AbstractVirtualDiskImageStatsTransformer extends AbstractTransformer
{
    ...
    {
                                                $iaasVirtualDiskImageId = \NextDeveloper\IAAS\Database\Models\VirtualDiskImages::where('id', $model->iaas_virtual_disk_image_id)->first();
                        
        return $this->buildPayload(
            [
            'id'  =>  $model->uuid,
            'iaas_virtual_disk_image_id'  =>  $iaasVirtualDiskImageId ? $iaasVirtualDiskImageId->uuid : null,
            'size'  =>  $model->size,
