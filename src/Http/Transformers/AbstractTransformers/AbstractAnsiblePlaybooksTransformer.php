...
class AbstractAnsiblePlaybooksTransformer extends AbstractTransformer
{
    ...
    public function includeMedia(AnsiblePlaybooks $model)
    {
    ...
    public function includeSocialMedia(AnsiblePlaybooks $model)
    {
    ...
    public function includeComments(AnsiblePlaybooks $model)
    {
    ...
    public function includeVotes(AnsiblePlaybooks $model)
    {
    ...
    public function includeMeta(AnsiblePlaybooks $model)
    {
    ...
    public function includePhoneNumbers(AnsiblePlaybooks $model)
    {
    ...
    public function includeAddresses(AnsiblePlaybooks $model)
    {
