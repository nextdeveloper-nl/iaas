...
class AbstractAnsiblePlaybookExecutionsTransformer extends AbstractTransformer
{
    ...
    public function includeStates(AnsiblePlaybookExecutions $model)
    {
    ...
    public function includeActions(AnsiblePlaybookExecutions $model)
    {
    ...
    public function includeMedia(AnsiblePlaybookExecutions $model)
    {
    ...
    public function includeSocialMedia(AnsiblePlaybookExecutions $model)
    {
    ...
    public function includeComments(AnsiblePlaybookExecutions $model)
    {
    ...
    public function includeVotes(AnsiblePlaybookExecutions $model)
    {
    ...
    public function includeMeta(AnsiblePlaybookExecutions $model)
    {
    ...
    public function includePhoneNumbers(AnsiblePlaybookExecutions $model)
    {
    ...
    public function includeAddresses(AnsiblePlaybookExecutions $model)
    {
