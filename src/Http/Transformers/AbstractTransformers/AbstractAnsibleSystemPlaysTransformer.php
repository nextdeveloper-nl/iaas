...
class AbstractAnsibleSystemPlaysTransformer extends AbstractTransformer
{
    ...
    public function includeMedia(AnsibleSystemPlays $model)
    {
    ...
    public function includeSocialMedia(AnsibleSystemPlays $model)
    {
    ...
    public function includeComments(AnsibleSystemPlays $model)
    {
    ...
    public function includeVotes(AnsibleSystemPlays $model)
    {
    ...
    public function includeMeta(AnsibleSystemPlays $model)
    {
    ...
    public function includePhoneNumbers(AnsibleSystemPlays $model)
    {
    ...
    public function includeAddresses(AnsibleSystemPlays $model)
    {
