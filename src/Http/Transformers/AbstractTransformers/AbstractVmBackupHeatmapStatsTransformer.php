 ...
 */
class AbstractVmBackupHeatmapStatsTransformer extends AbstractTransformer
{
    ...
    public function includeStates(VmBackupHeatmapStats $model)
    {
    ...
    public function includeActions(VmBackupHeatmapStats $model)
    {
    ...
    public function includeMedia(VmBackupHeatmapStats $model)
    {
    ...
    public function includeSocialMedia(VmBackupHeatmapStats $model)
    {
    ...
    public function includeComments(VmBackupHeatmapStats $model)
    {
    ...
    public function includeVotes(VmBackupHeatmapStats $model)
    {
    ...
    public function includeMeta(VmBackupHeatmapStats $model)
    {
    ...
    public function includePhoneNumbers(VmBackupHeatmapStats $model)
    {
    ...
    public function includeAddresses(VmBackupHeatmapStats $model)
    {
