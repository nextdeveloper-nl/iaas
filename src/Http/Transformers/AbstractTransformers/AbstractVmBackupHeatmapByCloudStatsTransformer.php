 ...
 */
class AbstractVmBackupHeatmapByCloudStatsTransformer extends AbstractTransformer
{
    ...
    public function includeStates(VmBackupHeatmapByCloudStats $model)
    {
    ...
    public function includeActions(VmBackupHeatmapByCloudStats $model)
    {
    ...
    public function includeMedia(VmBackupHeatmapByCloudStats $model)
    {
    ...
    public function includeSocialMedia(VmBackupHeatmapByCloudStats $model)
    {
    ...
    public function includeComments(VmBackupHeatmapByCloudStats $model)
    {
    ...
    public function includeVotes(VmBackupHeatmapByCloudStats $model)
    {
    ...
    public function includeMeta(VmBackupHeatmapByCloudStats $model)
    {
    ...
    public function includePhoneNumbers(VmBackupHeatmapByCloudStats $model)
    {
    ...
    public function includeAddresses(VmBackupHeatmapByCloudStats $model)
    {
