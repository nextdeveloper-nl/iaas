 ...
 */
class AbstractIaasComputeMemberTransformer extends AbstractTransformer {
    ...
    public function transform(IaasComputeMember $model) {
                        $iaasComputePoolId = \NextDeveloper\IAAS\Database\Models\IaasComputePool::where('id', $model->iaas_compute_pool_id)->first();
