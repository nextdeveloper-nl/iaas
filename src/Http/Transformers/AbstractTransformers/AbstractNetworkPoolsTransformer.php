...
class AbstractNetworkPoolsTransformer extends AbstractTransformer
{
    ...
    public function includeMedia(NetworkPools $model)
    {
    ...
    public function includeSocialMedia(NetworkPools $model)
    {
    ...
    public function includeComments(NetworkPools $model)
    {
    ...
    public function includeVotes(NetworkPools $model)
    {
    ...
    public function includeMeta(NetworkPools $model)
    {
    ...
    public function includePhoneNumbers(NetworkPools $model)
    {
    ...
    public function includeAddresses(NetworkPools $model)
    {
