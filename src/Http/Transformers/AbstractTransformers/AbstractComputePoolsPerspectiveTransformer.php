 ...
 */
class AbstractComputePoolsPerspectiveTransformer extends AbstractTransformer
{
    ...
    public function includeStates(ComputePoolsPerspective $model)
    {
    ...
    public function includeActions(ComputePoolsPerspective $model)
    {
    ...
    public function includeMedia(ComputePoolsPerspective $model)
    {
    ...
    public function includeSocialMedia(ComputePoolsPerspective $model)
    {
    ...
    public function includeComments(ComputePoolsPerspective $model)
    {
    ...
    public function includeVotes(ComputePoolsPerspective $model)
    {
    ...
    public function includeMeta(ComputePoolsPerspective $model)
    {
    ...
    public function includePhoneNumbers(ComputePoolsPerspective $model)
    {
    ...
    public function includeAddresses(ComputePoolsPerspective $model)
    {
