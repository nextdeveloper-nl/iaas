 ...
 */
class AbstractVirtualMachinesManagementPerspectiveTransformer extends AbstractTransformer
{
    ...
    public function transform(VirtualMachinesManagementPerspective $model)
    {
        ...
        return $this->buildPayload(
            ...
            'hypervisor_name_label'  =>  $model->hypervisor_name_label,
            'ip_addr'  =>  $model->ip_addr,
            'disk_name'  =>  $model->disk_name,
            'disk_hypervisor_uuid'  =>  $model->disk_hypervisor_uuid,
            'storage_volume_name'  =>  $model->storage_volume_name,
            'storage_volume_hypervisor_uuid'  =>  $model->storage_volume_hypervisor_uuid,
    ...
    public function includeStates(VirtualMachinesManagementPerspective $model)
    {
    ...
    public function includeActions(VirtualMachinesManagementPerspective $model)
    {
    ...
    public function includeMedia(VirtualMachinesManagementPerspective $model)
    {
    ...
    public function includeSocialMedia(VirtualMachinesManagementPerspective $model)
    {
    ...
    public function includeComments(VirtualMachinesManagementPerspective $model)
    {
    ...
    public function includeVotes(VirtualMachinesManagementPerspective $model)
    {
    ...
    public function includeMeta(VirtualMachinesManagementPerspective $model)
    {
    ...
    public function includePhoneNumbers(VirtualMachinesManagementPerspective $model)
    {
    ...
    public function includeAddresses(VirtualMachinesManagementPerspective $model)
    {
