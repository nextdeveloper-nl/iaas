...
class AbstractAnsibleSystemPlaybooksTransformer extends AbstractTransformer
{
    ...
    public function includeStates(AnsibleSystemPlaybooks $model)
    {
    ...
    public function includeActions(AnsibleSystemPlaybooks $model)
    {
    ...
    public function includeMedia(AnsibleSystemPlaybooks $model)
    {
    ...
    public function includeSocialMedia(AnsibleSystemPlaybooks $model)
    {
    ...
    public function includeComments(AnsibleSystemPlaybooks $model)
    {
    ...
    public function includeVotes(AnsibleSystemPlaybooks $model)
    {
    ...
    public function includeMeta(AnsibleSystemPlaybooks $model)
    {
    ...
    public function includePhoneNumbers(AnsibleSystemPlaybooks $model)
    {
    ...
    public function includeAddresses(AnsibleSystemPlaybooks $model)
    {
