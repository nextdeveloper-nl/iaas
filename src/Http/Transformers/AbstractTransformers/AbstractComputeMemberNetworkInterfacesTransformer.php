...
class AbstractComputeMemberNetworkInterfacesTransformer extends AbstractTransformer
{
    ...
    public function includeStates(ComputeMemberNetworkInterfaces $model)
    {
    ...
    public function includeActions(ComputeMemberNetworkInterfaces $model)
    {
    ...
    public function includeMedia(ComputeMemberNetworkInterfaces $model)
    {
    ...
    public function includeSocialMedia(ComputeMemberNetworkInterfaces $model)
    {
    ...
    public function includeComments(ComputeMemberNetworkInterfaces $model)
    {
    ...
    public function includeVotes(ComputeMemberNetworkInterfaces $model)
    {
    ...
    public function includeMeta(ComputeMemberNetworkInterfaces $model)
    {
    ...
    public function includePhoneNumbers(ComputeMemberNetworkInterfaces $model)
    {
    ...
    public function includeAddresses(ComputeMemberNetworkInterfaces $model)
    {
