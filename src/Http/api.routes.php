...
Route::prefix('iaas')->group(
    function () {
        ...
        Route::prefix('accounts-stats')->group(
            function () {
                Route::get('/', 'AccountsStats\AccountsStatsController@index');
                Route::get('/actions', 'AccountsStats\AccountsStatsController@getActions');

                Route::get('{iaas_accounts_stats}/tags ', 'AccountsStats\AccountsStatsController@tags');
                Route::post('{iaas_accounts_stats}/tags ', 'AccountsStats\AccountsStatsController@saveTags');
                Route::get('{iaas_accounts_stats}/addresses ', 'AccountsStats\AccountsStatsController@addresses');
                Route::post('{iaas_accounts_stats}/addresses ', 'AccountsStats\AccountsStatsController@saveAddresses');

                Route::get('/{iaas_accounts_stats}/{subObjects}', 'AccountsStats\AccountsStatsController@relatedObjects');
                Route::get('/{iaas_accounts_stats}', 'AccountsStats\AccountsStatsController@show');

                Route::post('/', 'AccountsStats\AccountsStatsController@store');
                Route::post('/{iaas_accounts_stats}/do/{action}', 'AccountsStats\AccountsStatsController@doAction');

                Route::patch('/{iaas_accounts_stats}', 'AccountsStats\AccountsStatsController@update');
                Route::delete('/{iaas_accounts_stats}', 'AccountsStats\AccountsStatsController@destroy');
            }
        );
