...
namespace NextDeveloper\IAAS\Http\Requests\IaasComputeMember;

use NextDeveloper\Commons\Http\Requests\AbstractFormRequest;

class IaasComputeMemberCreateRequest extends AbstractFormRequest
{
    ...
    public function rules() {
        return [
			...
			'hostname'              => 'required|string|max:45',
