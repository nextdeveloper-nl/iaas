...
class VirtualMachineMigrationsUpdateRequest extends AbstractFormRequest
{
    ...
    public function rules()
    {
        ...
        'source_iaas_compute_member_id' => 'nullable|exists:source_iaas_compute_members,uuid|uuid',
        'target_iaas_compute_member_id' => 'nullable|exists:target_iaas_compute_members,uuid|uuid',
