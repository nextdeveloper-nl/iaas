 ...
 */
class UpdateStorageVolumes extends AbstractAction
{
    ...
    {
        $this->setProgress(0, 'Updating compute member storage volumes started');
        ...
        $this->setProgress(100, 'Updating compute member storage volumes finished');
    }
}
