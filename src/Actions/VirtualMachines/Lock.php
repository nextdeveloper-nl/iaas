...
class Lock extends AbstractAction
{
    ...
    {
        $this->setProgress(0, 'Virtual machine is being locked.');
        ...
        Events::fire('locked:NextDeveloper\IAAS\VirtualMachines', $this->model);

        $this->setProgress(100, 'Virtual machine is locked');
    }
}
