...
/**
 * Class CloudNodesPerspectiveObserver
 *
...
class CloudNodesPerspectiveObserver
{
    ...
    public function creating(Model $model)
    {
        ...
        Events::fire('creating:NextDeveloper\IAAS\CloudNodesPerspective', $model);
    }
    ...
    public function saving(Model $model)
    {
        ...
        Events::fire('saving:NextDeveloper\IAAS\CloudNodesPerspective', $model);
    }
    ...
    {
        Events::fire('saved:NextDeveloper\IAAS\CloudNodesPerspective', $model);
    }
    ...
    public function deleting(Model $model)
    {
        ...
        Events::fire('deleting:NextDeveloper\IAAS\CloudNodesPerspective', $model);
    }
    ...
    public function restoring(Model $model)
    {
        ...
        Events::fire('restoring:NextDeveloper\IAAS\CloudNodesPerspective', $model);
    }
    ...
    {
        Events::fire('restored:NextDeveloper\IAAS\CloudNodesPerspective', $model);
    }
