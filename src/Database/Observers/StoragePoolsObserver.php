...
class StoragePoolsObserver
{
    ...
    public function creating(Model $model)
    {
        ...
        Events::fire('creating:NextDeveloper\IAAS\StoragePools', $model);
    }
    ...
    public function saving(Model $model)
    {
        ...
        Events::fire('saving:NextDeveloper\IAAS\StoragePools', $model);
    }
    ...
    {
        Events::fire('saved:NextDeveloper\IAAS\StoragePools', $model);
    }
    ...
    public function deleting(Model $model)
    {
        ...
        Events::fire('deleting:NextDeveloper\IAAS\StoragePools', $model);
    }
    ...
    public function restoring(Model $model)
    {
        ...
        Events::fire('restoring:NextDeveloper\IAAS\StoragePools', $model);
    }
    ...
    {
        Events::fire('restored:NextDeveloper\IAAS\StoragePools', $model);
    }
