...
class StorageVolumesObserver
{
    ...
    public function creating(Model $model)
    {
        ...
        Events::fire('creating:NextDeveloper\IAAS\StorageVolumes', $model);
    }
    ...
    public function saving(Model $model)
    {
        ...
        Events::fire('saving:NextDeveloper\IAAS\StorageVolumes', $model);
    }
    ...
    {
        Events::fire('saved:NextDeveloper\IAAS\StorageVolumes', $model);
    }
    ...
    public function deleting(Model $model)
    {
        ...
        Events::fire('deleting:NextDeveloper\IAAS\StorageVolumes', $model);
    }
    ...
    public function restoring(Model $model)
    {
        ...
        Events::fire('restoring:NextDeveloper\IAAS\StorageVolumes', $model);
    }
    ...
    {
        Events::fire('restored:NextDeveloper\IAAS\StorageVolumes', $model);
    }
