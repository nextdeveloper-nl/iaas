...
/**
 * Class ComputeMemberDevicesObserver
 *
...
class ComputeMemberDevicesObserver
{
    ...
    public function creating(Model $model)
    {
        ...
        Events::fire('creating:NextDeveloper\IAAS\ComputeMemberDevices', $model);
    }
    ...
    public function saving(Model $model)
    {
        ...
        Events::fire('saving:NextDeveloper\IAAS\ComputeMemberDevices', $model);
    }
    ...
    {
        Events::fire('saved:NextDeveloper\IAAS\ComputeMemberDevices', $model);
    }
    ...
    public function deleting(Model $model)
    {
        ...
        Events::fire('deleting:NextDeveloper\IAAS\ComputeMemberDevices', $model);
    }
    ...
    public function restoring(Model $model)
    {
        ...
        Events::fire('restoring:NextDeveloper\IAAS\ComputeMemberDevices', $model);
    }
    ...
    {
        Events::fire('restored:NextDeveloper\IAAS\ComputeMemberDevices', $model);
    }
