...
class StorageMembersObserver
{
    ...
    public function creating(Model $model)
    {
        ...
        Events::fire('creating:NextDeveloper\IAAS\StorageMembers', $model);
    }
    ...
    public function saving(Model $model)
    {
        ...
        Events::fire('saving:NextDeveloper\IAAS\StorageMembers', $model);
    }
    ...
    {
        Events::fire('saved:NextDeveloper\IAAS\StorageMembers', $model);
    }
    ...
    public function deleting(Model $model)
    {
        ...
        Events::fire('deleting:NextDeveloper\IAAS\StorageMembers', $model);
    }
    ...
    public function restoring(Model $model)
    {
        ...
        Events::fire('restoring:NextDeveloper\IAAS\StorageMembers', $model);
    }
    ...
    {
        Events::fire('restored:NextDeveloper\IAAS\StorageMembers', $model);
    }
