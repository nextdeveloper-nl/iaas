...
/**
 * Class StorageMemberDevicesObserver
 *
...
class StorageMemberDevicesObserver
{
    ...
    public function creating(Model $model)
    {
        ...
        Events::fire('creating:NextDeveloper\IAAS\StorageMemberDevices', $model);
    }
    ...
    public function saving(Model $model)
    {
        ...
        Events::fire('saving:NextDeveloper\IAAS\StorageMemberDevices', $model);
    }
    ...
    {
        Events::fire('saved:NextDeveloper\IAAS\StorageMemberDevices', $model);
    }
    ...
    public function deleting(Model $model)
    {
        ...
        Events::fire('deleting:NextDeveloper\IAAS\StorageMemberDevices', $model);
    }
    ...
    public function restoring(Model $model)
    {
        ...
        Events::fire('restoring:NextDeveloper\IAAS\StorageMemberDevices', $model);
    }
    ...
    {
        Events::fire('restored:NextDeveloper\IAAS\StorageMemberDevices', $model);
    }
