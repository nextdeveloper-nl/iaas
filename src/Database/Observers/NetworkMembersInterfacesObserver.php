...
/**
 * Class NetworkMembersInterfacesObserver
 *
...
class NetworkMembersInterfacesObserver
{
    ...
    public function creating(Model $model)
    {
        ...
        Events::fire('creating:NextDeveloper\IAAS\NetworkMembersInterfaces', $model);
    }
    ...
    public function saving(Model $model)
    {
        ...
        Events::fire('saving:NextDeveloper\IAAS\NetworkMembersInterfaces', $model);
    }
    ...
    {
        Events::fire('saved:NextDeveloper\IAAS\NetworkMembersInterfaces', $model);
    }
    ...
    public function deleting(Model $model)
    {
        ...
        Events::fire('deleting:NextDeveloper\IAAS\NetworkMembersInterfaces', $model);
    }
    ...
    public function restoring(Model $model)
    {
        ...
        Events::fire('restoring:NextDeveloper\IAAS\NetworkMembersInterfaces', $model);
    }
    ...
    {
        Events::fire('restored:NextDeveloper\IAAS\NetworkMembersInterfaces', $model);
    }
