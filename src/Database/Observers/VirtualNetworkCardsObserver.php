...
/**
 * Class VirtualNetworkCardsObserver
 *
...
class VirtualNetworkCardsObserver
{
    ...
    public function creating(Model $model)
    {
        ...
        Events::fire('creating:NextDeveloper\IAAS\VirtualNetworkCards', $model);
    }
    ...
    public function saving(Model $model)
    {
        ...
        Events::fire('saving:NextDeveloper\IAAS\VirtualNetworkCards', $model);
    }
    ...
    {
        Events::fire('saved:NextDeveloper\IAAS\VirtualNetworkCards', $model);
    }
    ...
    public function deleting(Model $model)
    {
        ...
        Events::fire('deleting:NextDeveloper\IAAS\VirtualNetworkCards', $model);
    }
    ...
    public function restoring(Model $model)
    {
        ...
        Events::fire('restoring:NextDeveloper\IAAS\VirtualNetworkCards', $model);
    }
    ...
    {
        Events::fire('restored:NextDeveloper\IAAS\VirtualNetworkCards', $model);
    }
