...
class AccountsStatsObserver
{
    ...
    public function creating(Model $model)
    {
        ...
        Events::fire('creating:NextDeveloper\IAAS\AccountsStats', $model);
    }
    ...
    public function saving(Model $model)
    {
        ...
        Events::fire('saving:NextDeveloper\IAAS\AccountsStats', $model);
    }
    ...
    {
        Events::fire('saved:NextDeveloper\IAAS\AccountsStats', $model);
    }
    ...
    public function deleting(Model $model)
    {
        ...
        Events::fire('deleting:NextDeveloper\IAAS\AccountsStats', $model);
    }
    ...
    public function restoring(Model $model)
    {
        ...
        Events::fire('restoring:NextDeveloper\IAAS\AccountsStats', $model);
    }
    ...
    {
        Events::fire('restored:NextDeveloper\IAAS\AccountsStats', $model);
    }
