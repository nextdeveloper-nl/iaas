...
class RepositoriesObserver
{
    ...
    public function creating(Model $model)
    {
        ...
        Events::fire('creating:NextDeveloper\IAAS\Repositories', $model);
    }
    ...
    public function saving(Model $model)
    {
        ...
        Events::fire('saving:NextDeveloper\IAAS\Repositories', $model);
    }
    ...
    {
        Events::fire('saved:NextDeveloper\IAAS\Repositories', $model);
    }
    ...
    public function deleting(Model $model)
    {
        ...
        Events::fire('deleting:NextDeveloper\IAAS\Repositories', $model);
    }
    ...
    public function restoring(Model $model)
    {
        ...
        Events::fire('restoring:NextDeveloper\IAAS\Repositories', $model);
    }
    ...
    {
        Events::fire('restored:NextDeveloper\IAAS\Repositories', $model);
    }
