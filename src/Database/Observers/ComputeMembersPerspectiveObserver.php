...
/**
 * Class ComputeMembersPerspectiveObserver
 *
...
class ComputeMembersPerspectiveObserver
{
    ...
    public function creating(Model $model)
    {
        ...
        Events::fire('creating:NextDeveloper\IAAS\ComputeMembersPerspective', $model);
    }
    ...
    public function saving(Model $model)
    {
        ...
        Events::fire('saving:NextDeveloper\IAAS\ComputeMembersPerspective', $model);
    }
    ...
    {
        Events::fire('saved:NextDeveloper\IAAS\ComputeMembersPerspective', $model);
    }
    ...
    public function deleting(Model $model)
    {
        ...
        Events::fire('deleting:NextDeveloper\IAAS\ComputeMembersPerspective', $model);
    }
    ...
    public function restoring(Model $model)
    {
        ...
        Events::fire('restoring:NextDeveloper\IAAS\ComputeMembersPerspective', $model);
    }
    ...
    {
        Events::fire('restored:NextDeveloper\IAAS\ComputeMembersPerspective', $model);
    }
