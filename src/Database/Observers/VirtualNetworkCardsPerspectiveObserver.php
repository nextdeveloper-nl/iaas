...
/**
 * Class VirtualNetworkCardsPerspectiveObserver
 *
...
class VirtualNetworkCardsPerspectiveObserver
{
    ...
    public function creating(Model $model)
    {
        ...
        Events::fire('creating:NextDeveloper\IAAS\VirtualNetworkCardsPerspective', $model);
    }
    ...
    public function saving(Model $model)
    {
        ...
        Events::fire('saving:NextDeveloper\IAAS\VirtualNetworkCardsPerspective', $model);
    }
    ...
    {
        Events::fire('saved:NextDeveloper\IAAS\VirtualNetworkCardsPerspective', $model);
    }
    ...
    public function deleting(Model $model)
    {
        ...
        Events::fire('deleting:NextDeveloper\IAAS\VirtualNetworkCardsPerspective', $model);
    }
    ...
    public function restoring(Model $model)
    {
        ...
        Events::fire('restoring:NextDeveloper\IAAS\VirtualNetworkCardsPerspective', $model);
    }
    ...
    {
        Events::fire('restored:NextDeveloper\IAAS\VirtualNetworkCardsPerspective', $model);
    }
