...
class VirtualMachinesObserver
{
    ...
    public function creating(Model $model)
    {
        ...
        Events::fire('creating:NextDeveloper\IAAS\VirtualMachines', $model);
    }
    ...
    public function saving(Model $model)
    {
        ...
        Events::fire('saving:NextDeveloper\IAAS\VirtualMachines', $model);
    }
    ...
    {
        Events::fire('saved:NextDeveloper\IAAS\VirtualMachines', $model);
    }
    ...
    public function deleting(Model $model)
    {
        ...
        Events::fire('deleting:NextDeveloper\IAAS\VirtualMachines', $model);
    }
    ...
    public function restoring(Model $model)
    {
        ...
        Events::fire('restoring:NextDeveloper\IAAS\VirtualMachines', $model);
    }
    ...
    {
        Events::fire('restored:NextDeveloper\IAAS\VirtualMachines', $model);
    }
