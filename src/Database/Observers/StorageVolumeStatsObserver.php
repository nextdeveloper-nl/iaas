...
/**
 * Class StorageVolumeStatsObserver
 *
...
class StorageVolumeStatsObserver
{
    ...
    public function creating(Model $model)
    {
        ...
        Events::fire('creating:NextDeveloper\IAAS\StorageVolumeStats', $model);
    }
    ...
    public function saving(Model $model)
    {
        ...
        Events::fire('saving:NextDeveloper\IAAS\StorageVolumeStats', $model);
    }
    ...
    {
        Events::fire('saved:NextDeveloper\IAAS\StorageVolumeStats', $model);
    }
    ...
    public function deleting(Model $model)
    {
        ...
        Events::fire('deleting:NextDeveloper\IAAS\StorageVolumeStats', $model);
    }
    ...
    public function restoring(Model $model)
    {
        ...
        Events::fire('restoring:NextDeveloper\IAAS\StorageVolumeStats', $model);
    }
    ...
    {
        Events::fire('restored:NextDeveloper\IAAS\StorageVolumeStats', $model);
    }
