...
class NetworkPoolsObserver
{
    ...
    public function creating(Model $model)
    {
        ...
        Events::fire('creating:NextDeveloper\IAAS\NetworkPools', $model);
    }
    ...
    public function saving(Model $model)
    {
        ...
        Events::fire('saving:NextDeveloper\IAAS\NetworkPools', $model);
    }
    ...
    {
        Events::fire('saved:NextDeveloper\IAAS\NetworkPools', $model);
    }
    ...
    public function deleting(Model $model)
    {
        ...
        Events::fire('deleting:NextDeveloper\IAAS\NetworkPools', $model);
    }
    ...
    public function restoring(Model $model)
    {
        ...
        Events::fire('restoring:NextDeveloper\IAAS\NetworkPools', $model);
    }
    ...
    {
        Events::fire('restored:NextDeveloper\IAAS\NetworkPools', $model);
    }
