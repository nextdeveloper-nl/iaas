...
class BackupJobsObserver
{
    ...
    public function creating(Model $model)
    {
        ...
        Events::fire('creating:NextDeveloper\IAAS\BackupJobs', $model);
    }
    ...
    {
        Events::fire('created:NextDeveloper\IAAS\BackupJobs', $model);
    }
    ...
    public function saving(Model $model)
    {
        ...
        Events::fire('saving:NextDeveloper\IAAS\BackupJobs', $model);
    }
    ...
    {
        Events::fire('saved:NextDeveloper\IAAS\BackupJobs', $model);
    }
    ...
    public function updating(Model $model)
    {
        ...
        Events::fire('updating:NextDeveloper\IAAS\BackupJobs', $model);
    }
    ...
    {
        Events::fire('updated:NextDeveloper\IAAS\BackupJobs', $model);
    }
    ...
    public function deleting(Model $model)
    {
        ...
        Events::fire('deleting:NextDeveloper\IAAS\BackupJobs', $model);
    }
    ...
    {
        Events::fire('deleted:NextDeveloper\IAAS\BackupJobs', $model);
    }
    ...
    public function restoring(Model $model)
    {
        ...
        Events::fire('restoring:NextDeveloper\IAAS\BackupJobs', $model);
    }
    ...
    {
        Events::fire('restored:NextDeveloper\IAAS\BackupJobs', $model);
    }
