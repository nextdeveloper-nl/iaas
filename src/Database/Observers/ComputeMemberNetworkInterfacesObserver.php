...
/**
 * Class ComputeMemberNetworkInterfacesObserver
 *
...
class ComputeMemberNetworkInterfacesObserver
{
    ...
    public function creating(Model $model)
    {
        ...
        Events::fire('creating:NextDeveloper\IAAS\ComputeMemberNetworkInterfaces', $model);
    }
    ...
    public function saving(Model $model)
    {
        ...
        Events::fire('saving:NextDeveloper\IAAS\ComputeMemberNetworkInterfaces', $model);
    }
    ...
    {
        Events::fire('saved:NextDeveloper\IAAS\ComputeMemberNetworkInterfaces', $model);
    }
    ...
    public function deleting(Model $model)
    {
        ...
        Events::fire('deleting:NextDeveloper\IAAS\ComputeMemberNetworkInterfaces', $model);
    }
    ...
    public function restoring(Model $model)
    {
        ...
        Events::fire('restoring:NextDeveloper\IAAS\ComputeMemberNetworkInterfaces', $model);
    }
    ...
    {
        Events::fire('restored:NextDeveloper\IAAS\ComputeMemberNetworkInterfaces', $model);
    }
