...
/**
 * Class StorageMemberStatsObserver
 *
...
class StorageMemberStatsObserver
{
    ...
    public function creating(Model $model)
    {
        ...
        Events::fire('creating:NextDeveloper\IAAS\StorageMemberStats', $model);
    }
    ...
    public function saving(Model $model)
    {
        ...
        Events::fire('saving:NextDeveloper\IAAS\StorageMemberStats', $model);
    }
    ...
    {
        Events::fire('saved:NextDeveloper\IAAS\StorageMemberStats', $model);
    }
    ...
    public function deleting(Model $model)
    {
        ...
        Events::fire('deleting:NextDeveloper\IAAS\StorageMemberStats', $model);
    }
    ...
    public function restoring(Model $model)
    {
        ...
        Events::fire('restoring:NextDeveloper\IAAS\StorageMemberStats', $model);
    }
    ...
    {
        Events::fire('restored:NextDeveloper\IAAS\StorageMemberStats', $model);
    }
