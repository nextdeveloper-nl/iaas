...
/**
 * Class VirtualMachineStatsObserver
 *
...
class VirtualMachineStatsObserver
{
    ...
    public function creating(Model $model)
    {
        ...
        Events::fire('creating:NextDeveloper\IAAS\VirtualMachineStats', $model);
    }
    ...
    public function saving(Model $model)
    {
        ...
        Events::fire('saving:NextDeveloper\IAAS\VirtualMachineStats', $model);
    }
    ...
    {
        Events::fire('saved:NextDeveloper\IAAS\VirtualMachineStats', $model);
    }
    ...
    public function deleting(Model $model)
    {
        ...
        Events::fire('deleting:NextDeveloper\IAAS\VirtualMachineStats', $model);
    }
    ...
    public function restoring(Model $model)
    {
        ...
        Events::fire('restoring:NextDeveloper\IAAS\VirtualMachineStats', $model);
    }
    ...
    {
        Events::fire('restored:NextDeveloper\IAAS\VirtualMachineStats', $model);
    }
