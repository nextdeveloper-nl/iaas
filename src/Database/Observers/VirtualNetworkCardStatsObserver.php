...
/**
 * Class VirtualNetworkCardStatsObserver
 *
...
class VirtualNetworkCardStatsObserver
{
    ...
    public function creating(Model $model)
    {
        ...
        Events::fire('creating:NextDeveloper\IAAS\VirtualNetworkCardStats', $model);
    }
    ...
    public function saving(Model $model)
    {
        ...
        Events::fire('saving:NextDeveloper\IAAS\VirtualNetworkCardStats', $model);
    }
    ...
    {
        Events::fire('saved:NextDeveloper\IAAS\VirtualNetworkCardStats', $model);
    }
    ...
    public function deleting(Model $model)
    {
        ...
        Events::fire('deleting:NextDeveloper\IAAS\VirtualNetworkCardStats', $model);
    }
    ...
    public function restoring(Model $model)
    {
        ...
        Events::fire('restoring:NextDeveloper\IAAS\VirtualNetworkCardStats', $model);
    }
    ...
    {
        Events::fire('restored:NextDeveloper\IAAS\VirtualNetworkCardStats', $model);
    }
