...
/**
 * Class ComputeMemberMetricsObserver
 *
...
class ComputeMemberMetricsObserver
{
    ...
    public function creating(Model $model)
    {
        ...
        Events::fire('creating:NextDeveloper\IAAS\ComputeMemberMetrics', $model);
    }
    ...
    public function saving(Model $model)
    {
        ...
        Events::fire('saving:NextDeveloper\IAAS\ComputeMemberMetrics', $model);
    }
    ...
    {
        Events::fire('saved:NextDeveloper\IAAS\ComputeMemberMetrics', $model);
    }
    ...
    public function deleting(Model $model)
    {
        ...
        Events::fire('deleting:NextDeveloper\IAAS\ComputeMemberMetrics', $model);
    }
    ...
    public function restoring(Model $model)
    {
        ...
        Events::fire('restoring:NextDeveloper\IAAS\ComputeMemberMetrics', $model);
    }
    ...
    {
        Events::fire('restored:NextDeveloper\IAAS\ComputeMemberMetrics', $model);
    }
