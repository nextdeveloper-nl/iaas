...
/**
 * Class VirtualDiskImagesObserver
 *
...
class VirtualDiskImagesObserver
{
    ...
    public function creating(Model $model)
    {
        ...
        Events::fire('creating:NextDeveloper\IAAS\VirtualDiskImages', $model);
    }
    ...
    public function saving(Model $model)
    {
        ...
        Events::fire('saving:NextDeveloper\IAAS\VirtualDiskImages', $model);
    }
    ...
    {
        Events::fire('saved:NextDeveloper\IAAS\VirtualDiskImages', $model);
    }
    ...
    public function deleting(Model $model)
    {
        ...
        Events::fire('deleting:NextDeveloper\IAAS\VirtualDiskImages', $model);
    }
    ...
    public function restoring(Model $model)
    {
        ...
        Events::fire('restoring:NextDeveloper\IAAS\VirtualDiskImages', $model);
    }
    ...
    {
        Events::fire('restored:NextDeveloper\IAAS\VirtualDiskImages', $model);
    }
