...
/**
 * Class AnsibleSystemPlaybookExecutionsObserver
 *
...
class AnsibleSystemPlaybookExecutionsObserver
{
    ...
    public function creating(Model $model)
    {
        ...
        Events::fire('creating:NextDeveloper\IAAS\AnsibleSystemPlaybookExecutions', $model);
    }
    ...
    public function saving(Model $model)
    {
        ...
        Events::fire('saving:NextDeveloper\IAAS\AnsibleSystemPlaybookExecutions', $model);
    }
    ...
    {
        Events::fire('saved:NextDeveloper\IAAS\AnsibleSystemPlaybookExecutions', $model);
    }
    ...
    public function deleting(Model $model)
    {
        ...
        Events::fire('deleting:NextDeveloper\IAAS\AnsibleSystemPlaybookExecutions', $model);
    }
    ...
    public function restoring(Model $model)
    {
        ...
        Events::fire('restoring:NextDeveloper\IAAS\AnsibleSystemPlaybookExecutions', $model);
    }
    ...
    {
        Events::fire('restored:NextDeveloper\IAAS\AnsibleSystemPlaybookExecutions', $model);
    }
