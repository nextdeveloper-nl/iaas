...
class DhcpServersObserver
{
    ...
    public function creating(Model $model)
    {
        ...
        Events::fire('creating:NextDeveloper\IAAS\DhcpServers', $model);
    }
    ...
    public function saving(Model $model)
    {
        ...
        Events::fire('saving:NextDeveloper\IAAS\DhcpServers', $model);
    }
    ...
    {
        Events::fire('saved:NextDeveloper\IAAS\DhcpServers', $model);
    }
    ...
    public function deleting(Model $model)
    {
        ...
        Events::fire('deleting:NextDeveloper\IAAS\DhcpServers', $model);
    }
    ...
    public function restoring(Model $model)
    {
        ...
        Events::fire('restoring:NextDeveloper\IAAS\DhcpServers', $model);
    }
    ...
    {
        Events::fire('restored:NextDeveloper\IAAS\DhcpServers', $model);
    }
