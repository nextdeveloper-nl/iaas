...
class AccountsObserver
{
    ...
    public function creating(Model $model)
    {
        ...
        Events::fire('creating:NextDeveloper\IAAS\Accounts', $model);
    }
    ...
    {
        Events::fire('created:NextDeveloper\IAAS\Accounts', $model);
    }
    ...
    public function saving(Model $model)
    {
        ...
        Events::fire('saving:NextDeveloper\IAAS\Accounts', $model);
    }
    ...
    {
        Events::fire('saved:NextDeveloper\IAAS\Accounts', $model);
    }
    ...
    public function updating(Model $model)
    {
        ...
        Events::fire('updating:NextDeveloper\IAAS\Accounts', $model);
    }
    ...
    {
        Events::fire('updated:NextDeveloper\IAAS\Accounts', $model);
    }
    ...
    public function deleting(Model $model)
    {
        ...
        Events::fire('deleting:NextDeveloper\IAAS\Accounts', $model);
    }
    ...
    {
        Events::fire('deleted:NextDeveloper\IAAS\Accounts', $model);
    }
    ...
    public function restoring(Model $model)
    {
        ...
        Events::fire('restoring:NextDeveloper\IAAS\Accounts', $model);
    }
    ...
    {
        Events::fire('restored:NextDeveloper\IAAS\Accounts', $model);
    }
