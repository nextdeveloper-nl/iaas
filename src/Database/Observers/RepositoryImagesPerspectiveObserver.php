...
/**
 * Class RepositoryImagesPerspectiveObserver
 *
...
class RepositoryImagesPerspectiveObserver
{
    ...
    public function creating(Model $model)
    {
        ...
        Events::fire('creating:NextDeveloper\IAAS\RepositoryImagesPerspective', $model);
    }
    ...
    public function saving(Model $model)
    {
        ...
        Events::fire('saving:NextDeveloper\IAAS\RepositoryImagesPerspective', $model);
    }
    ...
    {
        Events::fire('saved:NextDeveloper\IAAS\RepositoryImagesPerspective', $model);
    }
    ...
    public function deleting(Model $model)
    {
        ...
        Events::fire('deleting:NextDeveloper\IAAS\RepositoryImagesPerspective', $model);
    }
    ...
    public function restoring(Model $model)
    {
        ...
        Events::fire('restoring:NextDeveloper\IAAS\RepositoryImagesPerspective', $model);
    }
    ...
    {
        Events::fire('restored:NextDeveloper\IAAS\RepositoryImagesPerspective', $model);
    }
