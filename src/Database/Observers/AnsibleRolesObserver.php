...
class AnsibleRolesObserver
{
    ...
    public function creating(Model $model)
    {
        ...
        Events::fire('creating:NextDeveloper\IAAS\AnsibleRoles', $model);
    }
    ...
    public function saving(Model $model)
    {
        ...
        Events::fire('saving:NextDeveloper\IAAS\AnsibleRoles', $model);
    }
    ...
    {
        Events::fire('saved:NextDeveloper\IAAS\AnsibleRoles', $model);
    }
    ...
    public function deleting(Model $model)
    {
        ...
        Events::fire('deleting:NextDeveloper\IAAS\AnsibleRoles', $model);
    }
    ...
    public function restoring(Model $model)
    {
        ...
        Events::fire('restoring:NextDeveloper\IAAS\AnsibleRoles', $model);
    }
    ...
    {
        Events::fire('restored:NextDeveloper\IAAS\AnsibleRoles', $model);
    }
