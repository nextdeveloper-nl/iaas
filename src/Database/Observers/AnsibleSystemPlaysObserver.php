...
/**
 * Class AnsibleSystemPlaysObserver
 *
...
class AnsibleSystemPlaysObserver
{
    ...
    public function creating(Model $model)
    {
        ...
        Events::fire('creating:NextDeveloper\IAAS\AnsibleSystemPlays', $model);
    }
    ...
    public function saving(Model $model)
    {
        ...
        Events::fire('saving:NextDeveloper\IAAS\AnsibleSystemPlays', $model);
    }
    ...
    {
        Events::fire('saved:NextDeveloper\IAAS\AnsibleSystemPlays', $model);
    }
    ...
    public function deleting(Model $model)
    {
        ...
        Events::fire('deleting:NextDeveloper\IAAS\AnsibleSystemPlays', $model);
    }
    ...
    public function restoring(Model $model)
    {
        ...
        Events::fire('restoring:NextDeveloper\IAAS\AnsibleSystemPlays', $model);
    }
    ...
    {
        Events::fire('restored:NextDeveloper\IAAS\AnsibleSystemPlays', $model);
    }
