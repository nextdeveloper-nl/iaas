...
/**
 * Class ComputeMemberStorageVolumesPerspectiveObserver
 *
...
class ComputeMemberStorageVolumesPerspectiveObserver
{
    ...
    public function creating(Model $model)
    {
        ...
        Events::fire('creating:NextDeveloper\IAAS\ComputeMemberStorageVolumesPerspective', $model);
    }
    ...
    public function saving(Model $model)
    {
        ...
        Events::fire('saving:NextDeveloper\IAAS\ComputeMemberStorageVolumesPerspective', $model);
    }
    ...
    {
        Events::fire('saved:NextDeveloper\IAAS\ComputeMemberStorageVolumesPerspective', $model);
    }
    ...
    public function deleting(Model $model)
    {
        ...
        Events::fire('deleting:NextDeveloper\IAAS\ComputeMemberStorageVolumesPerspective', $model);
    }
    ...
    public function restoring(Model $model)
    {
        ...
        Events::fire('restoring:NextDeveloper\IAAS\ComputeMemberStorageVolumesPerspective', $model);
    }
    ...
    {
        Events::fire('restored:NextDeveloper\IAAS\ComputeMemberStorageVolumesPerspective', $model);
    }
