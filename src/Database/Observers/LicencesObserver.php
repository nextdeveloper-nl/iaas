...
class LicencesObserver
{
    ...
    public function creating(Model $model)
    {
        ...
        Events::fire('creating:NextDeveloper\IAAS\Licences', $model);
    }
    ...
    {
        Events::fire('created:NextDeveloper\IAAS\Licences', $model);
    }
    ...
    public function saving(Model $model)
    {
        ...
        Events::fire('saving:NextDeveloper\IAAS\Licences', $model);
    }
    ...
    {
        Events::fire('saved:NextDeveloper\IAAS\Licences', $model);
    }
    ...
    public function updating(Model $model)
    {
        ...
        Events::fire('updating:NextDeveloper\IAAS\Licences', $model);
    }
    ...
    {
        Events::fire('updated:NextDeveloper\IAAS\Licences', $model);
    }
    ...
    public function deleting(Model $model)
    {
        ...
        Events::fire('deleting:NextDeveloper\IAAS\Licences', $model);
    }
    ...
    {
        Events::fire('deleted:NextDeveloper\IAAS\Licences', $model);
    }
    ...
    public function restoring(Model $model)
    {
        ...
        Events::fire('restoring:NextDeveloper\IAAS\Licences', $model);
    }
    ...
    {
        Events::fire('restored:NextDeveloper\IAAS\Licences', $model);
    }
