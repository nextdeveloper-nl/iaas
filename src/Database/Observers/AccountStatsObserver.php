...
class AccountStatsObserver
{
    ...
    public function creating(Model $model)
    {
        ...
        Events::fire('creating:NextDeveloper\IAAS\AccountStats', $model);
    }
    ...
    public function saving(Model $model)
    {
        ...
        Events::fire('saving:NextDeveloper\IAAS\AccountStats', $model);
    }
    ...
    {
        Events::fire('saved:NextDeveloper\IAAS\AccountStats', $model);
    }
    ...
    public function deleting(Model $model)
    {
        ...
        Events::fire('deleting:NextDeveloper\IAAS\AccountStats', $model);
    }
    ...
    public function restoring(Model $model)
    {
        ...
        Events::fire('restoring:NextDeveloper\IAAS\AccountStats', $model);
    }
    ...
    {
        Events::fire('restored:NextDeveloper\IAAS\AccountStats', $model);
    }
