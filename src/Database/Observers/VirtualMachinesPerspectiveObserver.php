...
/**
 * Class VirtualMachinesPerspectiveObserver
 *
...
class VirtualMachinesPerspectiveObserver
{
    ...
    public function creating(Model $model)
    {
        ...
        Events::fire('creating:NextDeveloper\IAAS\VirtualMachinesPerspective', $model);
    }
    ...
    public function saving(Model $model)
    {
        ...
        Events::fire('saving:NextDeveloper\IAAS\VirtualMachinesPerspective', $model);
    }
    ...
    {
        Events::fire('saved:NextDeveloper\IAAS\VirtualMachinesPerspective', $model);
    }
    ...
    public function deleting(Model $model)
    {
        ...
        Events::fire('deleting:NextDeveloper\IAAS\VirtualMachinesPerspective', $model);
    }
    ...
    public function restoring(Model $model)
    {
        ...
        Events::fire('restoring:NextDeveloper\IAAS\VirtualMachinesPerspective', $model);
    }
    ...
    {
        Events::fire('restored:NextDeveloper\IAAS\VirtualMachinesPerspective', $model);
    }
