...
class NetworksObserver
{
    ...
    public function creating(Model $model)
    {
        ...
        Events::fire('creating:NextDeveloper\IAAS\Networks', $model);
    }
    ...
    public function saving(Model $model)
    {
        ...
        Events::fire('saving:NextDeveloper\IAAS\Networks', $model);
    }
    ...
    {
        Events::fire('saved:NextDeveloper\IAAS\Networks', $model);
    }
    ...
    public function deleting(Model $model)
    {
        ...
        Events::fire('deleting:NextDeveloper\IAAS\Networks', $model);
    }
    ...
    public function restoring(Model $model)
    {
        ...
        Events::fire('restoring:NextDeveloper\IAAS\Networks', $model);
    }
    ...
    {
        Events::fire('restored:NextDeveloper\IAAS\Networks', $model);
    }
