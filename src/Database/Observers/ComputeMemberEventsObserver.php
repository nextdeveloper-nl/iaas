...
/**
 * Class ComputeMemberEventsObserver
 *
...
class ComputeMemberEventsObserver
{
    ...
    public function creating(Model $model)
    {
        ...
        Events::fire('creating:NextDeveloper\IAAS\ComputeMemberEvents', $model);
    }
    ...
    public function saving(Model $model)
    {
        ...
        Events::fire('saving:NextDeveloper\IAAS\ComputeMemberEvents', $model);
    }
    ...
    {
        Events::fire('saved:NextDeveloper\IAAS\ComputeMemberEvents', $model);
    }
    ...
    public function deleting(Model $model)
    {
        ...
        Events::fire('deleting:NextDeveloper\IAAS\ComputeMemberEvents', $model);
    }
    ...
    public function restoring(Model $model)
    {
        ...
        Events::fire('restoring:NextDeveloper\IAAS\ComputeMemberEvents', $model);
    }
    ...
    {
        Events::fire('restored:NextDeveloper\IAAS\ComputeMemberEvents', $model);
    }
