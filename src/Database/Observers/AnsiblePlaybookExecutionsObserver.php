...
/**
 * Class AnsiblePlaybookExecutionsObserver
 *
...
class AnsiblePlaybookExecutionsObserver
{
    ...
    public function creating(Model $model)
    {
        ...
        Events::fire('creating:NextDeveloper\IAAS\AnsiblePlaybookExecutions', $model);
    }
    ...
    public function saving(Model $model)
    {
        ...
        Events::fire('saving:NextDeveloper\IAAS\AnsiblePlaybookExecutions', $model);
    }
    ...
    {
        Events::fire('saved:NextDeveloper\IAAS\AnsiblePlaybookExecutions', $model);
    }
    ...
    public function deleting(Model $model)
    {
        ...
        Events::fire('deleting:NextDeveloper\IAAS\AnsiblePlaybookExecutions', $model);
    }
    ...
    public function restoring(Model $model)
    {
        ...
        Events::fire('restoring:NextDeveloper\IAAS\AnsiblePlaybookExecutions', $model);
    }
    ...
    {
        Events::fire('restored:NextDeveloper\IAAS\AnsiblePlaybookExecutions', $model);
    }
