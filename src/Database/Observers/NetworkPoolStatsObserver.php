...
/**
 * Class NetworkPoolStatsObserver
 *
...
class NetworkPoolStatsObserver
{
    ...
    public function creating(Model $model)
    {
        ...
        Events::fire('creating:NextDeveloper\IAAS\NetworkPoolStats', $model);
    }
    ...
    {
        Events::fire('created:NextDeveloper\IAAS\NetworkPoolStats', $model);
    }
    ...
    public function saving(Model $model)
    {
        ...
        Events::fire('saving:NextDeveloper\IAAS\NetworkPoolStats', $model);
    }
    ...
    {
        Events::fire('saved:NextDeveloper\IAAS\NetworkPoolStats', $model);
    }
    ...
    public function updating(Model $model)
    {
        ...
        Events::fire('updating:NextDeveloper\IAAS\NetworkPoolStats', $model);
    }
    ...
    {
        Events::fire('updated:NextDeveloper\IAAS\NetworkPoolStats', $model);
    }
    ...
    public function deleting(Model $model)
    {
        ...
        Events::fire('deleting:NextDeveloper\IAAS\NetworkPoolStats', $model);
    }
    ...
    public function restoring(Model $model)
    {
        ...
        Events::fire('restoring:NextDeveloper\IAAS\NetworkPoolStats', $model);
    }
    ...
    {
        Events::fire('restored:NextDeveloper\IAAS\NetworkPoolStats', $model);
    }
