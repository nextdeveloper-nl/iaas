...
class DatacentersObserver
{
    ...
    public function creating(Model $model)
    {
        ...
        Events::fire('creating:NextDeveloper\IAAS\Datacenters', $model);
    }
    ...
    public function saving(Model $model)
    {
        ...
        Events::fire('saving:NextDeveloper\IAAS\Datacenters', $model);
    }
    ...
    {
        Events::fire('saved:NextDeveloper\IAAS\Datacenters', $model);
    }
    ...
    public function deleting(Model $model)
    {
        ...
        Events::fire('deleting:NextDeveloper\IAAS\Datacenters', $model);
    }
    ...
    public function restoring(Model $model)
    {
        ...
        Events::fire('restoring:NextDeveloper\IAAS\Datacenters', $model);
    }
    ...
    {
        Events::fire('restored:NextDeveloper\IAAS\Datacenters', $model);
    }
