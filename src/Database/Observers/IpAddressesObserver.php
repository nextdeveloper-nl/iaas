...
class IpAddressesObserver
{
    ...
    public function creating(Model $model)
    {
        ...
        Events::fire('creating:NextDeveloper\IAAS\IpAddresses', $model);
    }
    ...
    public function saving(Model $model)
    {
        ...
        Events::fire('saving:NextDeveloper\IAAS\IpAddresses', $model);
    }
    ...
    {
        Events::fire('saved:NextDeveloper\IAAS\IpAddresses', $model);
    }
    ...
    public function deleting(Model $model)
    {
        ...
        Events::fire('deleting:NextDeveloper\IAAS\IpAddresses', $model);
    }
    ...
    public function restoring(Model $model)
    {
        ...
        Events::fire('restoring:NextDeveloper\IAAS\IpAddresses', $model);
    }
    ...
    {
        Events::fire('restored:NextDeveloper\IAAS\IpAddresses', $model);
    }
