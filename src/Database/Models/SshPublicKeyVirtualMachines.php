...
use NextDeveloper\IAAS\Database\Observers\SshPublicKeyVirtualMachinesObserver;
...
/**
 * SshPublicKeyVirtualMachines model.
 *
 * @package  NextDeveloper\IAAS\Database\Models
 * @property integer $id
 * @property string $uuid
 * @property integer $iam_ssh_public_key_id
 ...
 */
class SshPublicKeyVirtualMachines extends Model
{
    ...
    protected $table = 'iaas_ssh_public_key_virtual_machines';
    ...
    public static function boot()
    {
        ...
        parent::observe(SshPublicKeyVirtualMachinesObserver::class);
    ...
    public static function registerScopes()
    {
        ...
        $modelScopes = config('iaas.scopes.iaas_ssh_public_key_virtual_machines');
