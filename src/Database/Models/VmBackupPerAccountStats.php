...
use NextDeveloper\IAAS\Database\Observers\VmBackupPerAccountStatsObserver;
 ...
 */
class VmBackupPerAccountStats extends Model
{
    use Filterable, UuidId, CleanCache, Taggable, HasStates, RunAsAdministrator, HasObject;

    public $timestamps = false;

    protected $table = 'iaas_vm_backup_per_account_stats';
    ...
    public static function boot()
    {
        ...
        parent::observe(VmBackupPerAccountStatsObserver::class);
    ...
    public static function registerScopes()
    {
        ...
        $modelScopes = config('iaas.scopes.iaas_vm_backup_per_account_stats');
