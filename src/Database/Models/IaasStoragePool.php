...
use NextDeveloper\IAAS\Database\Observers\IaasStoragePoolObserver;
use NextDeveloper\Commons\Database\Traits\UuidId;

/**
* Class IaasStoragePool.
*
* @package NextDeveloper\IAAS\Database\Models
*/
class IaasStoragePool extends Model
{
...
parent::observe(IaasStoragePoolObserver::class);
