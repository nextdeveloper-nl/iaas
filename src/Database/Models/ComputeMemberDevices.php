...
use NextDeveloper\IAAS\Database\Observers\ComputeMemberDevicesObserver;
use Illuminate\Notifications\Notifiable;
use NextDeveloper\Commons\Database\Traits\RunAsAdministrator;
use NextDeveloper\Commons\Database\Traits\HasObject;

/**
 * ComputeMemberDevices model.
 *
 ...
 */
class ComputeMemberDevices extends Model
{
    ...
    protected $table = 'iaas_compute_member_devices';
    ...
    public static function boot()
    {
        ...
        parent::observe(ComputeMemberDevicesObserver::class);
    ...
    public static function registerScopes()
    {
        ...
        $modelScopes = config('iaas.scopes.iaas_compute_member_devices');
