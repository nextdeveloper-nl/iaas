...
use NextDeveloper\IAAS\Database\Observers\VmBackupHeatmapStatsObserver;
 ...
 */
class VmBackupHeatmapStats extends Model
{
    use Filterable, UuidId, CleanCache, Taggable, HasStates, RunAsAdministrator, HasObject;

    public $timestamps = false;

    protected $table = 'iaas_vm_backup_heatmap_stats';
    ...
    public static function boot()
    {
        ...
        parent::observe(VmBackupHeatmapStatsObserver::class);
    ...
    public static function registerScopes()
    {
        ...
        $modelScopes = config('iaas.scopes.iaas_vm_backup_heatmap_stats');
