...
use NextDeveloper\IAAS\Database\Observers\VmBackupHeatmapByCloudsObserver;
 ...
 */
class VmBackupHeatmapByClouds extends Model
{
    use Filterable, UuidId, CleanCache, Taggable, HasStates, RunAsAdministrator, HasObject;

    public $timestamps = false;

    protected $table = 'iaas_vm_backup_heatmap_by_cloud';
    ...
    public static function boot()
    {
        ...
        parent::observe(VmBackupHeatmapByCloudsObserver::class);
    ...
    public static function registerScopes()
    {
        ...
        $modelScopes = config('iaas.scopes.iaas_vm_backup_heatmap_by_cloud');
