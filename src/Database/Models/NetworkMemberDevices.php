...
use NextDeveloper\IAAS\Database\Observers\NetworkMemberDevicesObserver;
use Illuminate\Notifications\Notifiable;
use NextDeveloper\Commons\Database\Traits\RunAsAdministrator;
use NextDeveloper\Commons\Database\Traits\HasObject;

/**
 * NetworkMemberDevices model.
 *
 ...
 */
class NetworkMemberDevices extends Model
{
    ...
    protected $table = 'iaas_network_member_devices';
    ...
    public static function boot()
    {
        ...
        parent::observe(NetworkMemberDevicesObserver::class);
    ...
    public static function registerScopes()
    {
        ...
        $modelScopes = config('iaas.scopes.iaas_network_member_devices');
