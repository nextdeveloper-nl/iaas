...
use NextDeveloper\IAAS\Database\Observers\EnvVarGroupVarsObserver;
 ...
 */
class EnvVarGroupVars extends Model
{
    ...
    protected $table = 'iaas_env_var_group_vars';
    ...
    public static function boot()
    {
        ...
        parent::observe(EnvVarGroupVarsObserver::class);
    ...
    public static function registerScopes()
    {
        ...
        $modelScopes = config('iaas.scopes.iaas_env_var_group_vars');
