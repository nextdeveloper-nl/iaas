...
use NextDeveloper\IAAS\Database\Observers\GatewaysObserver;
...
class Gateways extends Model
{
    ...
    public static function boot()
    {
        ...
        parent::observe(GatewaysObserver::class);
    ...
    public static function registerScopes()
    {
        ...
        $modelScopes = config('iaas.scopes.iaas_gateways');
