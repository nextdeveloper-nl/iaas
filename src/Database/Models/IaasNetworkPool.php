...
use NextDeveloper\IAAS\Database\Observers\IaasNetworkPoolObserver;
use NextDeveloper\Commons\Database\Traits\UuidId;

/**
* Class IaasNetworkPool.
*
* @package NextDeveloper\IAAS\Database\Models
*/
class IaasNetworkPool extends Model
{
...
parent::observe(IaasNetworkPoolObserver::class);
