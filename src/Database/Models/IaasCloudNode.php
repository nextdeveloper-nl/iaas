...
use NextDeveloper\IAAS\Database\Observers\IaasCloudNodeObserver;
...
*/
class IaasCloudNode extends Model
{
...
parent::observe(IaasCloudNodeObserver::class);
...
public function iaasDatacenter()
    ...
    public function iaasStoragePools()
    {
        return $this->hasMany(IaasStoragePool::class);
    }
