 ...
 */
class EnvVarGroupVarsQueryFilter extends AbstractQueryFilter
{
    /**
     * @var Builder
     */
    ...
    {
        $iaasEnvVarGroup = EnvVarGroups::where('uuid', $value)->first();
    ...
    //  This is an alias function of iaasEnvVarGroupId
    public function iaas_env_var_group_id($value)
    {
        return $this->iaasEnvVarGroupId($value);
    }
