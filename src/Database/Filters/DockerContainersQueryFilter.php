 ...
 */
class DockerContainersQueryFilter extends AbstractQueryFilter
{
    ...
    public function containerId($value)
    {
        return $this->builder->where('container_id', $value);
    }

        //  This is an alias function of containerId
    public function container_id($value)
    {
        return $this->containerId($value);
    }
    ...
    public function iaasVirtualMachineId($value)
    {
        ...
        //  This is an alias function of iaasVirtualMachineId
    public function iaas_virtual_machine_id($value)
    {
        return $this->iaasVirtualMachineId($value);
    }
