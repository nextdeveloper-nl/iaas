 ...
 *
 * Class VirtualNetworkCardStatsService.
 *
 * @package NextDeveloper\IAAS\Database\Models
 */
class AbstractVirtualNetworkCardStatsService
{
    public static function get(VirtualNetworkCardStatsQueryFilter $filter = null, array $params = []) : Collection|LengthAwarePaginator
    {
        ...
        */
        if($filter == null) {
            $filter = new VirtualNetworkCardStatsQueryFilter($request);
        }
        ...
        $model = VirtualNetworkCardStats::filter($filter);
    ...
    {
        return VirtualNetworkCardStats::all();
    }
     ...
     * @return mixed
     */
    public static function getByRef($ref) : ?VirtualNetworkCardStats
    {
        return VirtualNetworkCardStats::findByRef($ref);
    }

    public static function getActions()
    {
        $model = VirtualNetworkCardStats::class;
    ...
    public static function doAction($objectId, $action, ...$params)
    {
        ...
        $action = '\\NextDeveloper\\IAAS\\Actions\\VirtualNetworkCardStats\\' . Str::studly($action);
     ...
     *
     * @param  $id
     * @return VirtualNetworkCardStats|null
     */
    public static function getById($id) : ?VirtualNetworkCardStats
    {
        return VirtualNetworkCardStats::where('id', $id)->first();
    }
    ...
    {
        try {
            $obj = VirtualNetworkCardStats::where('uuid', $uuid)->first();
     ...
     *
     * @param  array $data
     * @return VirtualNetworkCardStats
     */
    public static function updateRaw(array $data) : ?VirtualNetworkCardStats
    {
