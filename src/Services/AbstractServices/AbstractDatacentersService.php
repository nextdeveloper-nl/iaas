 ...
 */
class AbstractDatacentersService
{
    public static function get(DatacentersQueryFilter $filter = null, array $params = []) : Collection|LengthAwarePaginator
    {
        ...
        */
        if($filter == null) {
            $filter = new DatacentersQueryFilter(new Request());
        }
        ...
        $model = Datacenters::filter($filter);
     ...
     * @return mixed
     */
    public static function getByRef($ref) : ?Datacenters
    {
        return Datacenters::findByRef($ref);
    }

    public static function getActions()
    {
        $model = Datacenters::class;
    ...
    public static function doAction($objectId, $action, ...$params)
    {
        ...
        $action = '\\NextDeveloper\\IAAS\\Actions\\Datacenters\\' . Str::studly($action);
     ...
     */
    public static function getById($id) : ?Datacenters
    {
        return Datacenters::where('id', $id)->first();
    }
