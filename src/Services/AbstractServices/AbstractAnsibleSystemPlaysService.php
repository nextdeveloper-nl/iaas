 ...
 *
 * Class AnsibleSystemPlaysService.
 *
 * @package NextDeveloper\IAAS\Database\Models
 */
class AbstractAnsibleSystemPlaysService
{
    public static function get(AnsibleSystemPlaysQueryFilter $filter = null, array $params = []) : Collection|LengthAwarePaginator
    {
     ...
     * @return mixed
     */
    public static function getByRef($ref) : ?AnsibleSystemPlays
    {
        return AnsibleSystemPlays::findByRef($ref);
    }

    public static function getActions()
    {
        $model = AnsibleSystemPlays::class;
    ...
    public static function doAction($objectId, $action, ...$params)
    {
        ...
        $action = '\\NextDeveloper\\IAAS\\Actions\\AnsibleSystemPlays\\' . Str::studly($action);
     ...
     *
     * @param  $id
     * @return AnsibleSystemPlays|null
     */
    public static function getById($id) : ?AnsibleSystemPlays
    {
        return AnsibleSystemPlays::where('id', $id)->first();
    }
    ...
    {
        try {
            $obj = AnsibleSystemPlays::where('uuid', $uuid)->first();
    ...
    public static function create(array $data)
    {
        ...
        try {
            $model = AnsibleSystemPlays::create($data);
        } catch(\Exception $e) {
            throw $e;
        }
     ...
     *
     * @param  array $data
     * @return AnsibleSystemPlays
     */
    public static function updateRaw(array $data) : ?AnsibleSystemPlays
    {
