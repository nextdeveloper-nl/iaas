 ...
 */
class AbstractIpAddressesService
{
    public static function get(IpAddressesQueryFilter $filter = null, array $params = []) : Collection|LengthAwarePaginator
    {
        ...
        */
        if($filter == null) {
            $filter = new IpAddressesQueryFilter(new Request());
        }
        ...
        $model = IpAddresses::filter($filter);
     ...
     * @return mixed
     */
    public static function getByRef($ref) : ?IpAddresses
    {
        return IpAddresses::findByRef($ref);
    }

    public static function getActions()
    {
        $model = IpAddresses::class;
    ...
    public static function doAction($objectId, $action, ...$params)
    {
        ...
        $action = '\\NextDeveloper\\IAAS\\Actions\\IpAddresses\\' . Str::studly($action);
     ...
     */
    public static function getById($id) : ?IpAddresses
    {
        return IpAddresses::where('id', $id)->first();
    }
    ...
    {
        try {
            $obj = IpAddresses::where('uuid', $uuid)->first();
     ...
     * @return IpAddresses
     */
    public static function updateRaw(array $data) : ?IpAddresses
    {
    ...
    {
        $model = IpAddresses::where('uuid', $id)->first();
