 ...
 */
class AbstractDhcpServersService
{
    public static function get(DhcpServersQueryFilter $filter = null, array $params = []) : Collection|LengthAwarePaginator
    {
        ...
        */
        if($filter == null) {
            $filter = new DhcpServersQueryFilter(new Request());
        }
        ...
        $model = DhcpServers::filter($filter);
     ...
     * @return mixed
     */
    public static function getByRef($ref) : ?DhcpServers
    {
        return DhcpServers::findByRef($ref);
    }

    public static function getActions()
    {
        $model = DhcpServers::class;
    ...
    public static function doAction($objectId, $action, ...$params)
    {
        ...
        $action = '\\NextDeveloper\\IAAS\\Actions\\DhcpServers\\' . Str::studly($action);
     ...
     *
     * @param  $id
     * @return DhcpServers|null
     */
    public static function getById($id) : ?DhcpServers
    {
        return DhcpServers::where('id', $id)->first();
    }
    ...
    {
        try {
            $obj = DhcpServers::where('uuid', $uuid)->first();
     ...
     * @return DhcpServers
     */
    public static function updateRaw(array $data) : ?DhcpServers
    {
    ...
    {
        $model = DhcpServers::where('uuid', $id)->first();
