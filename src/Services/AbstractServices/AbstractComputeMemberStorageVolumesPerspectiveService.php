...
/**
 * This class is responsible from managing the data for ComputeMemberStorageVolumesPerspective
 *
 * Class ComputeMemberStorageVolumesPerspectiveService.
 *
 * @package NextDeveloper\IAAS\Database\Models
 */
class AbstractComputeMemberStorageVolumesPerspectiveService
{
    public static function get(ComputeMemberStorageVolumesPerspectiveQueryFilter $filter = null, array $params = []) : Collection|LengthAwarePaginator
    {
        ...
        */
        if($filter == null) {
            $filter = new ComputeMemberStorageVolumesPerspectiveQueryFilter($request);
        }
        ...
        $model = ComputeMemberStorageVolumesPerspective::filter($filter);
    ...
    {
        return ComputeMemberStorageVolumesPerspective::all();
    }
     ...
     * @return mixed
     */
    public static function getByRef($ref) : ?ComputeMemberStorageVolumesPerspective
    {
        return ComputeMemberStorageVolumesPerspective::findByRef($ref);
    }

    public static function getActions()
    {
        $model = ComputeMemberStorageVolumesPerspective::class;
     ...
     *
     * @param  $id
     * @return ComputeMemberStorageVolumesPerspective|null
     */
    public static function getById($id) : ?ComputeMemberStorageVolumesPerspective
    {
        return ComputeMemberStorageVolumesPerspective::where('id', $id)->first();
    }
    ...
    {
        try {
            $obj = ComputeMemberStorageVolumesPerspective::where('uuid', $uuid)->first();
    ...
    public static function create(array $data)
    {
        ...
        try {
            $model = ComputeMemberStorageVolumesPerspective::create($data);
        } catch(\Exception $e) {
            throw $e;
        }
     ...
     *
     * @param  array $data
     * @return ComputeMemberStorageVolumesPerspective
     */
    public static function updateRaw(array $data) : ?ComputeMemberStorageVolumesPerspective
    {
    ...
    {
        $model = ComputeMemberStorageVolumesPerspective::where('uuid', $id)->first();
