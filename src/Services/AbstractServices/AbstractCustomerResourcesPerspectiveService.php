 ...
 */
class AbstractCustomerResourcesPerspectiveService
{
    ...
    {
        return CustomerResourcesPerspective::findByRef($ref);
    }

    public static function getActions()
    {
        $model = CustomerResourcesPerspective::class;
    ...
    {
        $object = CustomerResourcesPerspective::where('uuid', $objectId)->first();

        $action = AvailableActions::where('name', $action)
            ->where('input', 'NextDeveloper\IAAS\CustomerResourcesPerspective')
            ->first();
     ...
     *
     * @param  $id
     * @return CustomerResourcesPerspective|null
     */
    public static function getById($id) : ?CustomerResourcesPerspective
    {
        return CustomerResourcesPerspective::where('id', $id)->first();
    }
    ...
    {
        try {
            $obj = CustomerResourcesPerspective::where('uuid', $uuid)->first();
    ...
    public static function create(array $data)
    {
        ...
        if (array_key_exists('resource_id', $data)) {
            $data['resource_id'] = DatabaseHelper::uuidToId(
                '\NextDeveloper\\Database\Models\Resources',
                $data['resource_id']
            );
        }
        ...
        try {
            $model = CustomerResourcesPerspective::create($data);
        } catch(\Exception $e) {
            throw $e;
        }
     ...
     *
     * @param  array $data
     * @return CustomerResourcesPerspective
     */
    public static function updateRaw(array $data) : ?CustomerResourcesPerspective
    {
    ...
    {
        $model = CustomerResourcesPerspective::where('uuid', $id)->first();
