...
/**
 * This class is responsible from managing the data for ComputeMemberMetrics
 *
 * Class ComputeMemberMetricsService.
 *
...
class AbstractComputeMemberMetricsService
{
    public static function get(ComputeMemberMetricsQueryFilter $filter = null, array $params = []) : Collection|LengthAwarePaginator
    {
        ...
        */
        if($filter == null) {
            $filter = new ComputeMemberMetricsQueryFilter($request);
        }
        ...
        $model = ComputeMemberMetrics::filter($filter);
    ...
    {
        return ComputeMemberMetrics::all();
    }
     ...
     * @return mixed
     */
    public static function getByRef($ref) : ?ComputeMemberMetrics
    {
        return ComputeMemberMetrics::findByRef($ref);
    }

    public static function getActions()
    {
        $model = ComputeMemberMetrics::class;
     ...
     *
     * @param  $id
     * @return ComputeMemberMetrics|null
     */
    public static function getById($id) : ?ComputeMemberMetrics
    {
        return ComputeMemberMetrics::where('id', $id)->first();
    }
    ...
    {
        try {
            $obj = ComputeMemberMetrics::where('uuid', $uuid)->first();
    ...
    public static function create(array $data)
    {
        ...
        try {
            $model = ComputeMemberMetrics::create($data);
        } catch(\Exception $e) {
            throw $e;
        }
     ...
     */
    public static function updateRaw(array $data) : ?ComputeMemberMetrics
    {
    ...
    {
        $model = ComputeMemberMetrics::where('uuid', $id)->first();
