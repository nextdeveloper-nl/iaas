...
/**
 * This class is responsible from managing the data for StorageMemberDevices
 *
 * Class StorageMemberDevicesService.
 *
...
class AbstractStorageMemberDevicesService
{
    public static function get(StorageMemberDevicesQueryFilter $filter = null, array $params = []) : Collection|LengthAwarePaginator
    {
        ...
        */
        if($filter == null) {
            $filter = new StorageMemberDevicesQueryFilter(new Request());
        }
        ...
        $model = StorageMemberDevices::filter($filter);
    ...
    {
        return StorageMemberDevices::all();
    }
     ...
     * @return mixed
     */
    public static function getByRef($ref) : ?StorageMemberDevices
    {
        return StorageMemberDevices::findByRef($ref);
    }

    public static function getActions()
    {
        $model = StorageMemberDevices::class;
    ...
    public static function doAction($objectId, $action, ...$params)
    {
        ...
        $action = '\\NextDeveloper\\IAAS\\Actions\\StorageMemberDevices\\' . Str::studly($action);
     ...
     *
     * @param  $id
     * @return StorageMemberDevices|null
     */
    public static function getById($id) : ?StorageMemberDevices
    {
        return StorageMemberDevices::where('id', $id)->first();
    }
    ...
    {
        try {
            $obj = StorageMemberDevices::where('uuid', $uuid)->first();
    ...
    public static function create(array $data)
    {
        ...
        try {
            $model = StorageMemberDevices::create($data);
        } catch(\Exception $e) {
            throw $e;
        }
     ...
     *
     * @param  array $data
     * @return StorageMemberDevices
     */
    public static function updateRaw(array $data) : ?StorageMemberDevices
    {
    ...
    {
        $model = StorageMemberDevices::where('uuid', $id)->first();
