 ...
 *
 * Class ComputeMemberStatsService.
 *
 * @package NextDeveloper\IAAS\Database\Models
 */
class AbstractComputeMemberStatsService
{
    public static function get(ComputeMemberStatsQueryFilter $filter = null, array $params = []) : Collection|LengthAwarePaginator
    {
        ...
        */
        if($filter == null) {
            $filter = new ComputeMemberStatsQueryFilter($request);
        }
        ...
        $model = ComputeMemberStats::filter($filter);
     ...
     * @return mixed
     */
    public static function getByRef($ref) : ?ComputeMemberStats
    {
        return ComputeMemberStats::findByRef($ref);
    }

    public static function getActions()
    {
        $model = ComputeMemberStats::class;
    ...
    {
        $object = ComputeMemberStats::where('uuid', $objectId)->first();

        $action = '\\NextDeveloper\\IAAS\\Actions\\ComputeMemberStats\\' . Str::studly($action);
     ...
     *
     * @param  $id
     * @return ComputeMemberStats|null
     */
    public static function getById($id) : ?ComputeMemberStats
    {
        return ComputeMemberStats::where('id', $id)->first();
    }
    ...
    {
        try {
            $obj = ComputeMemberStats::where('uuid', $uuid)->first();
    ...
    public static function create(array $data)
    {
        ...
        try {
            $model = ComputeMemberStats::create($data);
        } catch(\Exception $e) {
            throw $e;
        }
     ...
     */
    public static function updateRaw(array $data) : ?ComputeMemberStats
    {
