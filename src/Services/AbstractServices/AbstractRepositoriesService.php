 ...
 */
class AbstractRepositoriesService
{
    public static function get(RepositoriesQueryFilter $filter = null, array $params = []) : Collection|LengthAwarePaginator
    {
        ...
        */
        if($filter == null) {
            $filter = new RepositoriesQueryFilter(new Request());
        }
        ...
        $model = Repositories::filter($filter);
     ...
     * @return mixed
     */
    public static function getByRef($ref) : ?Repositories
    {
        return Repositories::findByRef($ref);
    }

    public static function getActions()
    {
        $model = Repositories::class;
    ...
    public static function doAction($objectId, $action, ...$params)
    {
        ...
        $action = '\\NextDeveloper\\IAAS\\Actions\\Repositories\\' . Str::studly($action);
     ...
     */
    public static function getById($id) : ?Repositories
    {
        return Repositories::where('id', $id)->first();
    }
    ...
    {
        try {
            $obj = Repositories::where('uuid', $uuid)->first();
     ...
     * @return Repositories
     */
    public static function updateRaw(array $data) : ?Repositories
    {
    ...
    {
        $model = Repositories::where('uuid', $id)->first();
