...
class AbstractGatewaysService
{
    public static function get(GatewaysQueryFilter $filter = null, array $params = []) : Collection|LengthAwarePaginator
    {
        ...
        */
        if($filter == null) {
            $filter = new GatewaysQueryFilter(new Request());
        }
     ...
     * @return mixed
     */
    public static function getByRef($ref) : ?Gateways
    {
        return Gateways::findByRef($ref);
    }

    public static function getActions()
    {
        $model = Gateways::class;
    ...
    public static function doAction($objectId, $action, ...$params)
    {
        ...
        $action = '\\NextDeveloper\\IAAS\\Actions\\Gateways\\' . Str::studly($action);
     ...
     */
    public static function getById($id) : ?Gateways
    {
        return Gateways::where('id', $id)->first();
    }
    ...
    {
        try {
            $obj = Gateways::where('uuid', $uuid)->first();
     ...
     * @return Gateways
     */
    public static function updateRaw(array $data) : ?Gateways
    {
    ...
    {
        $model = Gateways::where('uuid', $id)->first();
