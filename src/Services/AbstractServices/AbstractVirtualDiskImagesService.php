 ...
 */
class AbstractVirtualDiskImagesService
{
    public static function get(VirtualDiskImagesQueryFilter $filter = null, array $params = []) : Collection|LengthAwarePaginator
    {
        ...
        */
        if($filter == null) {
            $filter = new VirtualDiskImagesQueryFilter(new Request());
        }
        ...
        $model = VirtualDiskImages::filter($filter);
     ...
     * @return mixed
     */
    public static function getByRef($ref) : ?VirtualDiskImages
    {
        return VirtualDiskImages::findByRef($ref);
    }

    public static function getActions()
    {
        $model = VirtualDiskImages::class;
     ...
     *
     * @param  $id
     * @return VirtualDiskImages|null
     */
    public static function getById($id) : ?VirtualDiskImages
    {
        return VirtualDiskImages::where('id', $id)->first();
    }
    ...
    {
        try {
            $obj = VirtualDiskImages::where('uuid', $uuid)->first();
     ...
     *
     * @param  array $data
     * @return VirtualDiskImages
     */
    public static function updateRaw(array $data) : ?VirtualDiskImages
    {
    ...
    {
        $model = VirtualDiskImages::where('uuid', $id)->first();
